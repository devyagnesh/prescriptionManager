...
import com.example.iOptical.CallBack.MyButtonClickListener;
...
public abstract class MySwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    private float swipeTheshold = 0.5f;
    ...
    private synchronized void recoverSwipedItrem(){
    ...
    public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        if(buttonBuffer.containsKey(swipePosition))
            ...
            buttonList.clear();
        buttonBuffer.clear();
        swipeTheshold = 0.5f * buttonList.size()*buttonWidth;
